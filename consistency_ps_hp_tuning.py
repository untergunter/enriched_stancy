...
from PartOfSpeechPreProcceser import PartOfSpeechDataSet
...
def add_to_result_csv(loss,f1,precision,
  ...
  df.to_csv('/home/ido/data/idc/advanced ml/final_project/bert_consistency_pos_hp.csv',
...
def train_consistency(batch_size,lr,eps):
    ...
    pos_dataset_maker = PartOfSpeechDataSet()
    train_together_only_loader, train_together_and_claim_loader = \
        pos_dataset_maker.make_data_sets(train,batch_size)
    # dev_together_only_loader, dev_together_and_claim_loader = \
    #     PartOfSpeechDataSet(dev,batch_size)
    test_together_only_loader, test_together_and_claim_loader = \
        pos_dataset_maker.make_data_sets(test,batch_size)
